...
public class MoniSistemaService {
    ...
    private final SystemStatusRepository statusRepo;
    private final SystemAlertRepository alertRepo;
    private final SystemMetricRepository metricRepo;

    public MoniSistemaService(SystemStatusRepository statusRepo, SystemAlertRepository alertRepo, SystemMetricRepository metricRepo) {
